...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#0f1112] text-white overflow-visible pb-10">
      ...
      {/* ===================== MAIN CONTENT ===================== */}
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-15 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/80">
              ...
              <li><Link href="/faq" className="hover:text-white transition">FAQ &amp; ANS</Link></li>
            </ul>
          </div>

          {/* Get In Touch */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Get It Touch</h3>
...
>
  <svg
    className="icon-sm"            /* small helper class */
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
    strokeWidth="2"
  >
    <path d="M2 12l18-9-9 18-2-7-7-2z" />
      ...
      {/* ===================== BOTTOM BAR ===================== */}
      {/* Bottom bar with logo left, text center, icons right */}
<div className="bg-[#f0414f] pt-6 pb-6 mt-12 relative z-10">
  <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
    ...
    <div className="flex items-center gap-4">
      ...
      <div className="flex items-center gap-3">
        <a href="#" className="p-2 bg-white/20 rounded-md hover:bg-white/30 transition">
