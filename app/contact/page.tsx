...
export default function Contact() {
  ...
  `}</style>
        ...
        <div
          ref={headingRef}
          className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center"
        >
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-0 pointer-events-none">
          <svg
            ...
            className="w-full h-20 md:h-[100px] lg:h-[120px] block"
            aria-hidden="true"
            focusable="false"
          >
            <path
  ...
  `}</style>
        ...
        <div className="absolute -top-1 left-0 w-full overflow-hidden leading-0 pointer-events-none">
          <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-[60px] block" aria-hidden="true" focusable="false">
            <path
              d="M0,0 C150,80 350,80 600,40 C850,0 1050,0 1200,60 L1200,120 L0,120 Z"
              fill="#fff8f7"
            />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white border-2 border-[#f0414f] rounded-2xl shadow-soft p-10">
              ...
              {/* Map Embed */}
              <div
                className="w-full h-60 mb-8 rounded-xl overflow-hidden border border-[#f0414f]"
                role="region"
                aria-label="Map showing Sigma Graphics location"
              >
                <iframe
                  title="Sigma Graphics Location — Moodbidri"
              ...
              <div className="space-y-2 mb-6 text-[15px] font-semibold">
                <div className="flex items-center gap-3">
                  <Phone aria-hidden="true" focusable={false} className="w-5 h-5 text-[#f0414f]" />
                  <a href="tel:+919743730632" aria-label="Call +91 9743730632">+91 9743730632</a>
                </div>
                <div className="flex items-center gap-3">
                  <Phone aria-hidden="true" focusable={false} className="w-5 h-5 text-[#f0414f]" />
                  <a href="tel:+919731070591" aria-label="Call +91 9731070591">+91 9731070591</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 font-semibold text-[15px]">
                <Mail aria-hidden="true" focusable={false} className="w-5 h-5 text-[#f0414f]" />
                <a href="mailto:sigmapraphics22@gmail.com" aria-label="Email Sigma Graphics">
                  sigmapraphics22@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="relative bg-white/90 backdrop-blur-md border-2 border-[#f0414f] rounded-2xl shadow-xl p-10 overflow-hidden">
              {/* Decorative shapes */}
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#f0414f]/20 rounded-full blur-2xl" aria-hidden="true" />
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#f0414f]/10 rounded-full blur-2xl" aria-hidden="true" />
              ...
              <div className="relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6" aria-labelledby="contact-form-heading">
                  ...
                  {/* Number */}
                  <div>
                    <label htmlFor="number" className="block text-sm font-semibold text-gray-700 mb-1">Number</label>
                    <Input
                      id="number"
                      name="number"
                      type="tel"
                      ...
                      inputMode="tel"
                    />
                    <p id="number-help" className="text-xs text-gray-500 mt-1">
                      {form.number.length} / {maxNumberChars} characters max
                    </p>
                  </div>
